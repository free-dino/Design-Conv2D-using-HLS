...
#
# Script generated by Vivado on Sun Nov 24 22:32:52 +0700 2024
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Conv2D_design.sh
...
#
# Usage        : Conv2D_design.sh
#                Conv2D_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Conv2D_design.sh [-reset_run]
#                Conv2D_design.sh [-reset_log]
#                Conv2D_design.sh [-help]
#
...
# script info
echo -e "Conv2D_design.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Conv2D_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Conv2D_design xil_defaultlib.Conv2D_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Conv2D_design -key {Behavioral:sim_1:Functional:Conv2D_design} -tclbatch cmd.tcl -protoinst "protoinst_files/Conv2D_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Conv2D_design.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Conv2D_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Conv2D_design.sh [-help]\n\
Usage: Conv2D_design.sh [-step]\n\
Usage: Conv2D_design.sh [-lib_map_path]\n\
Usage: Conv2D_design.sh [-reset_run]\n\
Usage: Conv2D_design.sh [-reset_log]\n\
Usage: Conv2D_design.sh [-keep_index]\n\
Usage: Conv2D_design.sh [-noclean_files]\n\n\
