# ==============================================================
# File generated on Wed Dec 18 18:09:05 +0700 2024
...
$(ObjDir)/convolution2D.c_pre.c.tb.o : convolution2D.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) convolution2D.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
