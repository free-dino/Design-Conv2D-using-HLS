...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.convolution2D.autotvout_output_r.dat", "r");
    fp2 = $fopen("./impl_rtl.convolution2D.autotvout_output_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.convolution2D.autotvout_output_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.convolution2D.autotvout_output_r.dat\"!");
    else begin
        $display("Comparing rtl.convolution2D.autotvout_output_r.dat with impl_rtl.convolution2D.autotvout_output_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
